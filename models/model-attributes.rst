...
visit the `WebLauncher Framework API <http://api.WebLauncher Framework.org/2.4/class-Model.html>`_.
...
The recursive property defines how deep WebLauncher Framework should go to fetch
...
* -1 WebLauncher Framework fetches Group data only, no joins.
* 0  WebLauncher Framework fetches Group data and its domain
* 1  WebLauncher Framework fetches a Group, its domain and its associated Users
* 2  WebLauncher Framework fetches a Group, its domain, its associated Users, and the
  Users' associated Articles

Set it no higher than you need. Having WebLauncher Framework fetch data you
