...
.. note::
    ...
    `WebLauncher Framework DataSources repository on GitHub <https://github.com/WebLauncher Framework/datasources/tree/2.0>`_.

When specifying a database connection configuration in
``app/Config/database.php``, WebLauncher Framework transparently uses the corresponding
